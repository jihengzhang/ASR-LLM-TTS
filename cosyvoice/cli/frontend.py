...
try:
    ...
    try:
        ...
        print("WeTextProcessing not available, using fallback text processing")
        ZhNormalizer = None
        EnNormalizer = None
        use_ttsfrd = False
...
class CosyVoiceFrontEnd:
    ...
    def __init__(self,
        ...
        if self.use_ttsfrd:
            ...
            if ZhNormalizer is not None and EnNormalizer is not None:
                self.zh_tn_model = ZhNormalizer(remove_erhua=False, full_to_half=False)
                self.en_tn_model = EnNormalizer()
            else:
                print("Warning: Text normalizers not available, using raw text")
    ...
    def text_normalize(self, text, split=True):
        ...
        if contains_chinese(text):
            if self.use_ttsfrd:
                ...
                # Continue with basic text processing regardless of normalizer
            text = text.replace("\n", "")
