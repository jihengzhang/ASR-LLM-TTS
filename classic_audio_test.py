...
class AudioDeviceManager:
    def __init__(self, device_name: str = "ESP-ADF-AUD"):
        ...
        # HFP settings
        self.hfp_sample_rate = 48000 #8000 #48000 # 44100 #16000
    ...
    def _find_device_endpoints(self):
        ...
        preferred_apis = [0, 1, 2]  # 2 WASAPI, 1 DirectSound, 0 MME
    ...
    def create_stream(self, input_enabled: bool = True, 
        ...
        """创建音频流,支持全双工/半双工模式,确保使用相同的音频API"""
        ...
        if force_hfp or input_mode == 'HFP' or output_mode == 'HFP':
            ...
            print(f"🎯 Stream mode: HFP (采样率 {sample_rate}Hz)")
        else:
        ...
        try:
            ...
            print(f"✅ Stream mode: {'HFP' if is_hfp_stream else 'Non-HFP'}")
